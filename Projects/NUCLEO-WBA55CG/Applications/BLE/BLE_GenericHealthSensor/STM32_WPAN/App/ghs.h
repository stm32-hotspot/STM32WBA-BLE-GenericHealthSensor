...
typedef enum
{
  ...
  GHS_SHO_NOTIFY_ENABLED_EVT,
  GHS_SHO_NOTIFY_DISABLED_EVT,
  GHS_SHO_INDICATE_ENABLED_EVT,
  GHS_SHO_INDICATE_DISABLED_EVT,
  GHS_RACP_WRITE_EVT,
  GHS_RACP_INDICATE_ENABLED_EVT,
  GHS_RACP_INDICATE_DISABLED_EVT,
  GHS_GHSCP_WRITE_EVT,
...
{
  GHS_SegmentationHeader_t SegmentationHeader;
  GHS_SHOSegment_t StoredHealthObservationSegment;
}GHS_SHO_t;

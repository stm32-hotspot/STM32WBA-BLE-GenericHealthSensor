        ...
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
        {
          ...
          if(p_attribute_modified->Attr_Handle == (ETS_Context.CetCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))
          {
            ...
            switch(p_attribute_modified->Attr_Data[0])
            {
              ...
              case COMSVC_Indication:
                /* USER CODE BEGIN Service5_Char_1_COMSVC_Indication_BEGIN */

                /* USER CODE END Service5_Char_1_COMSVC_Indication_BEGIN */
                notification.EvtOpcode = ETS_CET_INDICATE_ENABLED_EVT;
                ETS_Notification(&notification);
                /* USER CODE BEGIN Service5_Char_1_COMSVC_Indication_END */

                /* USER CODE END Service5_Char_1_COMSVC_Indication_END */
                break;
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (ETS_Context.CETHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/

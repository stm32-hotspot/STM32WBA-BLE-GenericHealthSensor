...
typedef struct{
  ...
  uint16_t  ShoCharHdle;                  /**< SHO Characteristic Handle */
...
static const uint16_t SizeSho = 80;
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch(p_blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
        {
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.HSFHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.LhoCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/

          else if(p_attribute_modified->Attr_Handle == (GHS_Context.ShoCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            ...
            switch(p_attribute_modified->Attr_Data[0])
            {
              ...
              case (!(COMSVC_Notification) | !(COMSVC_Indication)):
                ...
                notification.EvtOpcode = GHS_SHO_NOTIFY_DISABLED_EVT;
                GHS_Notification(&notification);
                notification.EvtOpcode = GHS_SHO_INDICATE_DISABLED_EVT;
                GHS_Notification(&notification);
              ...
              case COMSVC_Notification:
                ...
                notification.EvtOpcode = GHS_SHO_NOTIFY_ENABLED_EVT;
                GHS_Notification(&notification);
              ...
              case COMSVC_Indication:
                ...
                notification.EvtOpcode = GHS_SHO_INDICATE_ENABLED_EVT;
                GHS_Notification(&notification);
              ...
              case (COMSVC_Indication | COMSVC_Notification):
                /* USER CODE BEGIN Service1_Char_3_COMSVC_Indication_BEGIN */
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.ShoCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/

          else if(p_attribute_modified->Attr_Handle == (GHS_Context.RacpCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            ...
            switch(p_attribute_modified->Attr_Data[0])
            {
              ...
              case (!(COMSVC_Indication)):
                ...
                notification.EvtOpcode = GHS_RACP_INDICATE_DISABLED_EVT;
                GHS_Notification(&notification);
              ...
              case COMSVC_Indication:
                ...
                notification.EvtOpcode = GHS_RACP_INDICATE_ENABLED_EVT;
                GHS_Notification(&notification);
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.RACPHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/
          ...
          else if(p_attribute_modified->Attr_Handle == (GHS_Context.GhscpCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))
          {
            ...
            switch(p_attribute_modified->Attr_Data[0])
            {
              ...
              /* Enabled Indication management */
              case COMSVC_Indication:
                /* USER CODE BEGIN Service1_Char_5_COMSVC_Indication_BEGIN */

                /* USER CODE END Service1_Char_5_COMSVC_Indication_BEGIN */
                notification.EvtOpcode = GHS_GHSCP_INDICATE_ENABLED_EVT;
                GHS_Notification(&notification);
                /* USER CODE BEGIN Service1_Char_5_COMSVC_Indication_END */

                /* USER CODE END Service1_Char_5_COMSVC_Indication_END */
                break;
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.GHSCPHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/
          ...
          }  /* if(p_attribute_modified->Attr_Handle == (GHS_Context.OSCHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))*/

          else if(p_attribute_modified->Attr_Handle == (GHS_Context.RacpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;

            notification.EvtOpcode = GHS_RACP_WRITE_EVT;
            ...
            GHS_Notification(&notification);
          } /* if(p_attribute_modified->Attr_Handle == (GHS_Context.RacpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))*/
          else if(p_attribute_modified->Attr_Handle == (GHS_Context.GhscpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            ...
            GHS_Notification(&notification);
          } /* if(p_attribute_modified->Attr_Handle == (GHS_Context.GhscpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))*/
        ...
        case ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE:
        {
          ...
          if(p_write_perm_req->Attribute_Handle == (GHS_Context.RacpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            /*USER CODE BEGIN Service1_Char_4_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE */
            LOG_INFO_APP("ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE GHS_RACP, data length: %d\r\n", p_write_perm_req->Data_Length);
        
            error_code = GHS_RACP_CheckRequestValid(p_write_perm_req->Data, p_write_perm_req->Data_Length);
            if (error_code == 0x00)
            {
              ...
              LOG_INFO_APP("ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE GHS_RACP >>> PERMITTED\r\n");
              GHS_RACP_RequestHandler(p_write_perm_req->Data, p_write_perm_req->Data_Length);
            }
            else 
            {
              aci_gatt_write_resp(p_write_perm_req->Connection_Handle,
                                  ...
                                  p_write_perm_req->Data_Length,
                                  p_write_perm_req->Data);
              if(error_code == GHS_ATT_ERROR_CODE_PROCEDURE_ALREADY_IN_PROGRESS)
              {
                LOG_INFO_APP("ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE GHS_RACP >>> PROCEDURE ALREADY IN PROGRESS (0x%02X)\r\n", error_code);
              }
              else if(error_code == GHS_ATT_ERROR_CODE_CLIENT_CHAR_CONF_DESC_IMPROPERLY_CONFIGURED)
              {
                LOG_INFO_APP("ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE GHS_RACP >>> CLIENT CHAR CONF DESC IMPROPERLY CONFIGURED (0x%02X)\r\n", error_code);
              }
            }
            /*USER CODE END Service1_Char_4_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE*/
          } /*if(p_write_perm_req->Attribute_Handle == (GHS_Context.RacpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))*/

          else if(p_write_perm_req->Attribute_Handle == (GHS_Context.GhscpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            /*USER CODE BEGIN Service1_Char_5_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE */
            ...
            /*USER CODE END Service1_Char_5_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE*/
...
void GHS_Init(void)
{
   ...
   *                                1 for SHO configuration descriptor +
  ...
  ret = aci_gatt_add_char(GHS_Context.GhsSvcHdle,
                          ...
                          0x10,
                          CHAR_VALUE_LEN_VARIABLE,
                          &(GHS_Context.ShoCharHdle));
  if (ret != BLE_STATUS_SUCCESS)
  {
    LOG_INFO_APP("  Fail   : aci_gatt_add_char command   : SHO, error code: 0x%2X\n", ret);
  }
  else
  {
    LOG_INFO_APP("  Success: aci_gatt_add_char command   : SHO\n");
  }
...
tBleStatus GHS_UpdateValue(GHS_CharOpcode_t CharOpcode, GHS_Data_t *pData)
{
  ...
  switch(CharOpcode)
  {
    ...
    case GHS_SHO:
      ...
      if (ret != BLE_STATUS_SUCCESS)
      {
        LOG_INFO_APP("  Fail   : aci_gatt_update_char_value SHO command, error code: 0x%2X\n", ret);
      }
      else
      {
        LOG_INFO_APP("  Success: aci_gatt_update_char_value SHO command\n");
      }
  ...
  if(CharOpcode == GHS_SHO_CCCD)
  {
    ret = aci_gatt_set_desc_value(GHS_Context.GhsSvcHdle,
                                  GHS_Context.ShoCharHdle,
                                  GHS_Context.ShoCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET,
                                  0, /* charValOffset */
                                  1, /* charValueLen */
                                  (uint8_t *)pData->p_Payload);
    if (ret != BLE_STATUS_SUCCESS)
    {
      LOG_INFO_APP("  Fail   : aci_gatt_set_desc_value SHO CCCD command, error code: 0x%2X\n", ret);
    }
    else
    {
      LOG_INFO_APP("  Success: aci_gatt_set_desc_value SHO CCCD command\n");
    }
  }

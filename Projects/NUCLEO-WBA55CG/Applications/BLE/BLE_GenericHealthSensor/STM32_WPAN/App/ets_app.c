...
void ETS_Notification(ETS_NotificationEvt_t *p_Notification)
{
  ...
  switch(p_Notification->EvtOpcode)
  {
    ...
    case ETS_CET_INDICATE_ENABLED_EVT:
      /* USER CODE BEGIN Service5Char1_INDICATE_ENABLED_EVT */

      /* USER CODE END Service5Char1_INDICATE_ENABLED_EVT */
      break;

    case ETS_CET_INDICATE_DISABLED_EVT:
      /* USER CODE BEGIN Service5Char1_INDICATE_DISABLED_EVT */

      /* USER CODE END Service5Char1_INDICATE_DISABLED_EVT */
      break;
...
__USED void ETS_Cet_SendIndication(void) /* Property Indication */
{
  ...
  /* USER CODE BEGIN Service5Char1_IS_1*/

  /* USER CODE END Service5Char1_IS_1*/
  ...
  /* USER CODE BEGIN Service5Char1_IS_Last*/

  /* USER CODE END Service5Char1_IS_Last*/
